...
var baseLayers = {
    "OpenTopoMap": new leaflet.TileLayer(
    ...
    "None": new L.layerGroup()
                ...
                self.map.addLayer(baseLayers["OpenTopoMap"]);
                ...
                var overlays = (params && params.overlays) ? params.overlays : {};
                overlays["OpenSeaMap"] = new leaflet.TileLayer(
